...
{
    public partial class delete_cpu : Form
    {
        public delete_cpu()
        {
            InitializeComponent();
        ...
        public void connectsql()
        {
            try
            {
                ...
                string selectQuery = "SELECT CPU_model FROM cpu WHERE 1";
                connection.Open();
        ...
        {
            string select = this.comboBox_cpu.Text;
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            if (Result == DialogResult.OK)
            {
                ...
                {
                    MySqlConnection connection = new MySqlConnection("server=100.25.117.10;uid=admin;pwd=0000;database=pc;CharSet=utf8;");
                    string selectQuery = "DELETE FROM `cpu` WHERE CPU_model='" + comboBox_cpu.Text + "' ";
                    connection.Open();
                    MySqlCommand command = new MySqlCommand(selectQuery, connection);
        ...
        private void delete_cpu_Load(object sender, EventArgs e)
        {
