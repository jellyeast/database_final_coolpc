...
namespace 保固頁
{
    public partial class menu : Form
    {
        ...
        {
            MySqlConnection connection = new MySqlConnection("server=localhost;uid=root;pwd=A130863543;database=pc;CharSet=utf8;");
        ...
        private void Form2_Load(object sender, EventArgs e)//表格項目放入
        {
            ImageList imgList = new ImageList();
            imgList.ImageSize = new Size(1, 30);
            listView_menu.SmallImageList = imgList;
            listView_menu.GridLines = true;
            listView_menu.FullRowSelect = true;

            listView_menu.View = View.Details;
            listView_menu.Scrollable = true;
            listView_menu.MultiSelect = false;

            listView_menu.Columns.Add("零件", 70, HorizontalAlignment.Center);
            listView_menu.Columns.Add("品名", 270, HorizontalAlignment.Center);
            listView_menu.Columns.Add("廠牌", 90, HorizontalAlignment.Center);
            listView_menu.Columns.Add("代理商名字", 100, HorizontalAlignment.Center);
            listView_menu.Columns.Add("電話", 100, HorizontalAlignment.Center);
            listView_menu.Columns.Add("網站", 300, HorizontalAlignment.Center);
        }
        //連結batabase的listview  表格內的每一項顯示
