...
{
    public partial class insertpsu : Form
    {
        public insertpsu()
        {
            InitializeComponent();
        ...
        private void insert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string selectQuery = "INSERT INTO `psu`(`brand`, `P_watt`, `P_model`, `price`) VALUES ('" + brand.Text + "','" + P_watt.Text + "','" + P_model.Text + "','" + price.Text + "')";
                connection.Open();
        ...
        public void display_select()
        {
            ...
            {
                MySqlConnection connection = new MySqlConnection("server=100.25.117.10;uid=admin;pwd=0000;database=pc;CharSet=utf8;");
                string selectQuery = "SELECT * FROM psu WHERE 1";
                connection.Open();
                MySqlCommand command = new MySqlCommand(selectQuery, connection);
                ...
                while (reader.Read())
                {
                    select.Items.Add(reader.GetString("P_model"));
                }
                connection.Close();
            }
            catch (Exception ex)
        ...
        public void display_P_watt()
        {
            try
            {
                MySqlConnection connection = new MySqlConnection("server=100.25.117.10;uid=admin;pwd=0000;database=pc;CharSet=utf8;");
                string selectQuery = "SELECT * FROM P_watt WHERE 1";
                connection.Open();
                MySqlCommand command = new MySqlCommand(selectQuery, connection);
                ...
                while (reader.Read())
                {
                    P_watt.Items.Add(reader.GetString("P_watt"));
                }
                connection.Close();
            }
            catch (Exception ex)
        ...
        public void display_brand()
        {
            ...
            {
                MySqlConnection connection = new MySqlConnection("server=100.25.117.10;uid=admin;pwd=0000;database=pc;CharSet=utf8;");
                string selectQuery = "SELECT * FROM psu_brand WHERE 1";
                connection.Open();
                MySqlCommand command = new MySqlCommand(selectQuery, connection);
        ...
        private void insertpsu_Load(object sender, EventArgs e)
        {
        ...
        private void update_Click(object sender, EventArgs e)
        {
            ...
            {
                MySqlConnection connection = new MySqlConnection("server=100.25.117.10;uid=admin;pwd=0000;database=pc;CharSet=utf8;");
                string selectQuery = "UPDATE `psu` SET `brand`='" + brand.Text + "',`P_watt`='" + P_watt.Text + "',`P_model`='" + P_model.Text + "',`price`='" + price.Text + "' WHERE P_model='" + select.Text + "'";
                connection.Open();
                MySqlCommand command = new MySqlCommand(selectQuery, connection);
