...
{
    public partial class delete_ssd : Form
    {
        public delete_ssd()
        {
            InitializeComponent();
        ...
        public void connectsql()
        {
            try
            {
                ...
                string selectQuery = "SELECT SSD_model FROM ssd WHERE 1";
                connection.Open();
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            if (Result == DialogResult.OK)
            {
                ...
                {
                    MySqlConnection connection = new MySqlConnection("server=100.25.117.10;uid=admin;pwd=0000;database=pc;CharSet=utf8;");
                    string selectQuery = "DELETE FROM `ssd` WHERE SSD_model='" + comboBox_ssd.Text + "' ";
                    connection.Open();
                    MySqlCommand command = new MySqlCommand(selectQuery, connection);
        ...
        private void delete_ssd_Load(object sender, EventArgs e)
        {
        ...
        {
            string select = this.comboBox_ssd.Text;
