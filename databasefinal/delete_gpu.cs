...
{
    public partial class delete_gpu : Form
    {
        public delete_gpu()
        {
            InitializeComponent();
        ...
        public void connectsql()
        {
            try
            {
                ...
                string selectQuery = "SELECT G_model FROM gpu WHERE 1";
                connection.Open();
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            if (Result == DialogResult.OK)
            {
                ...
                {
                    MySqlConnection connection = new MySqlConnection("server=100.25.117.10;uid=admin;pwd=0000;database=pc;CharSet=utf8;");
                    string selectQuery = "DELETE FROM `gpu` WHERE G_model='" + comboBox_gpu.Text + "' ";
                    connection.Open();
                    MySqlCommand command = new MySqlCommand(selectQuery, connection);
        ...
        private void delete_gpu_Load(object sender, EventArgs e)
        {
        ...
        {
            string select = this.comboBox_gpu.Text;
