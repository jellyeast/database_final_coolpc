...
{
    public partial class delete_propose : Form
    {
        public delete_propose()
        {
            InitializeComponent();
            connectsql();
        }
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            if (Result == DialogResult.OK)
            {
                try
                {
                    ...
                    string selectQuery = "DELETE FROM `propose` WHERE propose='" + comboBox_propose.Text + "'";
                    connection.Open();
        ...
        public void connectsql()
        {
            try
            {
                ...
                while (reader.Read())
                {
                    comboBox_propose.Items.Add(reader.GetString("propose"));
                }
                connection.Close();
            }
            catch (Exception ex)
